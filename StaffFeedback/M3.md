...
You qualified for a Blue Belt 🥋🔵 and got a final team grade of 5.09/6 for M3. Excellent work! You're demonstrating advanced skills.
...
|------------------------------------------|----------------------------------|------------|--------------------------------------------|
| **Completeness**                         | 4.5 out of 6 | 20%        | [See Details](#completeness)               |
| **Functionality**                        | 5.2 out of 6 | 20%       | [See Details](#functionality)              |
| **User Experience**                      | 5.6 out of 6 | 5%       | [See Details](#user-experience)            |
| **Design and Maintainability**           | 5.4 out of 6 | 20% | [See Details](#design-and-maintainability) |
| **QA (Testing)**                         | 5.23 out of 6           | 20%        | [See Details](#qa-testing)                 |
| **Documentation**                        | 4.45 out of 6 | 10%       | [See Details](#documentation)              |
| **Autonomy**                             | 6 out of 6     | 5%         | [See Details](#autonomy)                   |
| **Final Team Grade**                     | **5.09 out of 6** |            |                                            |
...
Whilst your app improved a lot, there are still quite a few things that didn't work:
- It doesn't work on all phone sizes
- Wrong audio plays immediately after posting
- The piano doesn't work
- When posting, the waveform is incorrect
...
Great job overall, the main issues were with the piano, which doesn't work and often makes the app crash
...
Whilst very intuitive, your app still has some significant pain points for users:
- Can't cancel project edition from the tempo setup screen
- If music is played on the tempo setup screen, it can't be stopped after the screen is closed.
- When in white mode, there are some text elements that are white on white.
...
Your code is quite good, but your app isn't very scalable as it is.
...
For this part, you received 5.23/6.
...
The code documentation is both incomplete and inconsistent.

You did not explain the use and integration of APIs (like SoundTouch).

For this part, you received 4.45/6.
...
Based on the above points, your grade for this M3 milestone is 5.09/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
