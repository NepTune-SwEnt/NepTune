...
class ProjectExtractor {
    ...
    fun extractMetadata(zipFile: File): SamplerProjectMetadata {
        ...
        ZipFile(zipFile).use { zip ->
            val entry: ZipEntry = zip.getEntry("config.json")
    ...
    /**
     * Finds the local audio file URI within the extracted ZIP structure.
     * NOTE: This would return a temporary path to the extracted audio file.
