...
object RecommendationEngine {
  ...
  /**
   * Calculates a popularity score for user based on the number of downloads and likes, recency and
   * tags of a sample
   */
  ...
  /**
   * Calculates the similarity of a sample's tags with a user's top tags between 0 and 1, where 1
   * means a perfect match.
   */
  fun tagSimilarity(userTagProfile: Map<String, Double>, sampleTags: List<String>): Double {
  ...
  fun recencyScore(creationTime: Long, now: Long): Double {
